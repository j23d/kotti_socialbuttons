if(jQuery) (function(jQuery) {
    jQuery(document).ready(function() {
        if(jQuery().socialSharePrivacy && $('.socialshareprivacy').length > 0) {
            ...
            var kotti_socialbuttons_services = {
                facebook: {
                    'status':         'on',
                    'dummy_img':      '',
            ...
            if ($.inArray('facebook', social_media_buttons) == -1) {
                kotti_socialbuttons_services['facebook']['status'] = 'off';
            }
            if ($.inArray('twitter', social_media_buttons) == -1) {
                kotti_socialbuttons_services['twitter']['status'] = 'off';
            }
            if ($.inArray('google', social_media_buttons) == -1) {
                kotti_socialbuttons_services['gplus']['status'] = 'off';
            }

            $('.socialshareprivacy').socialSharePrivacy({
                services: kotti_socialbuttons_services,
                'css_path' : ''
            });
        }
    });
